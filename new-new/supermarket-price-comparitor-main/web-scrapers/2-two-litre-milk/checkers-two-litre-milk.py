...
def _scrape():
    #state the url
    url = "https://www.checkers.co.za/All-Departments/Food/Fresh-Food/Milk%2C-Butter-and-Eggs/Milk/Checkers-Housebrand-Fresh-Full-Cream-Milk-2L/p/10164636EA"
...
def update_db(_price):
    ...
    cur = conn.cursor()
    cur.execute("UPDATE groceries SET checkers_price = (%s) WHERE id=2;", (_price,))
    conn.commit()
