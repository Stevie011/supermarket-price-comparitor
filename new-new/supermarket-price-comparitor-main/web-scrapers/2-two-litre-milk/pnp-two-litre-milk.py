...
def _scrape():
    #state the url
    url = "https://www.pnp.co.za/pnpstorefront/pnp/en/All-Products/Milk%2C-Dairy-%26-Eggs/Milk-%26-Cream/Fresh-Milk/PnP-Full-Cream-Fresh-Milk-2l/p/000000000000357781_EA"
...
def update_db(_price):
    ...
    cur = conn.cursor()
    cur.execute("UPDATE groceries SET pnp_price = (%s) WHERE id=2;", (_price,))
    conn.commit()   
