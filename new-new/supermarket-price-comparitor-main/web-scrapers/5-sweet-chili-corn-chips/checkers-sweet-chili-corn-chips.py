...
def _scrape():
    #state the url
    url = "https://www.checkers.co.za/All-Departments/Food/Food-Cupboard/Chips%2C-Snacks-and-Popcorn/Large-Bag-Chips/Doritos-Sweet-Chilli-Flavoured-Corn-Chips-145g/p/10189175EA"
...
def update_db(_price):
    ...
    cur = conn.cursor()
    cur.execute("UPDATE groceries SET checkers_price = (%s) WHERE id=5;", (_price,))
    conn.commit()
