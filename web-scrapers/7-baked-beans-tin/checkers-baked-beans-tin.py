...
def _scrape():
    #state the url
    url = "https://www.checkers.co.za/All-Departments/Food/Food-Cupboard/Canned-Food/Canned-Pulses%2C-Lentils-and-Beans/Rhodes-Baked-Beans-In-Tomato-Sauce-410g/p/10123940EA"
...
def update_db(_price):
    ...
    cur = conn.cursor()
    cur.execute("UPDATE groceries SET checkers_price = (%s) WHERE id=7;", (_price,))
    conn.commit()
