...
def _scrape():
    #state the url
    url = "https://www.checkers.co.za/All-Departments/Food/Fresh-Food/Fresh-Fruit/Strawberries%2C-Berries-and-Cherries/Strawberries-Pack-350g/p/10734542EA"
...
def update_db(_price):
    ...
    cur = conn.cursor()
    cur.execute("UPDATE groceries SET checkers_price = (%s) WHERE id=6;", (_price,))
    conn.commit()
