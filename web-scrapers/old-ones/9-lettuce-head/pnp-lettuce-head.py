...
def _scrape():
    ...
    url = "https://www.pnp.co.za/pnpstorefront/pnp/en/All-Products/Fresh-Fruit-%26-Vegetables/Vegetables/Peppers/PnP-Lettuce-Heads-Crisp/p/000000000000260540_EA"
...
def update_db(_price):
    ...
    cur = conn.cursor()
    cur.execute("UPDATE groceries SET pnp_price = (%s) WHERE id=9;", (_price,))
    conn.commit()   
