...
def _scrape():
    #state the url
    url = "https://www.woolworths.co.za/prod/Food/Fruit-Vegetables-Salads/Salads-Herbs/Lettuce-Mixed-Leaves/Iceberg-Lettuce-Head/_/A-20004071?isFromPLP=true"
...
def update_db(_price):
    ...
    cur = conn.cursor()
    cur.execute("UPDATE groceries SET woolworths_price = (%s) WHERE id=9;", (_price,))
    conn.commit()
