...
def _scrape():
    #state the url
    url = "https://www.woolworths.co.za/prod/Food/Fruit-Vegetables-Salads/Fresh-Vegetables/Mushrooms/Button-Mushrooms-250-g/_/A-20008918?isFromPLP=true"
...
def update_db(_price):
    ...
    cur = conn.cursor()
    cur.execute("UPDATE groceries SET woolworths_price = (%s) WHERE id=11;", (_price,))
    conn.commit()
