...
def _scrape():
    #state the url
    url = "https://www.woolworths.co.za/prod/Food/Household-Cleaning/Household/Toilet-Paper-Tissues-Wipes/Toilet-Paper/Baby-Soft-White-2-Ply-Toilet-Paper-18-pk/_/A-6001019000252?isFromPLP=true"
...
def update_db(_price):
    ...
    cur = conn.cursor()
    cur.execute("UPDATE groceries SET woolworths_price = (%s) WHERE id=4;", (_price,))
    conn.commit()
