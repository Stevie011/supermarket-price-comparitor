...
def _scrape():
    #state the url
    url = "https://www.pnp.co.za/pnpstorefront/pnp/en/All-Products/Chocolates%2C-Chips-%26-Snacks/Chips-%26-Dips/Chips/Corn-Chips/Dorito-Sweet-Chilli-Pepper-145g/p/000000000000864420_EA"
...
def update_db(_price):
    ...
    cur = conn.cursor()
    cur.execute("UPDATE groceries SET pnp_price = (%s) WHERE id=5;", (_price,))
    conn.commit()   
