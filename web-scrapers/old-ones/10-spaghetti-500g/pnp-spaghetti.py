...
def _scrape():
    ...
    url = "https://www.pnp.co.za/pnpstorefront/pnp/en/All-Products/Food-Cupboard/Pasta-%26-Noodles/Spaghetti/PnP-No-Name-Pasta-Spaghetti-500g/p/000000000000686676_EA"
...
def update_db(_price):
    ...
    cur = conn.cursor()
    cur.execute("UPDATE groceries SET pnp_price = (%s) WHERE id=10;", (_price,))
    conn.commit()   
