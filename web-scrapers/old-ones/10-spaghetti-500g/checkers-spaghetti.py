...
def _scrape():
    #state the url
    url = "https://www.checkers.co.za/All-Departments/Food/Food-Cupboard/Rice%2C-Pasta%2C-Noodles-and-Cous-Cous/Pasta/Toscana-Spaghetti-Pasta-500g/p/10131587EA"
...
def update_db(_price):
    ...
    cur = conn.cursor()
    cur.execute("UPDATE groceries SET checkers_price = (%s) WHERE id=10;", (_price,))
    conn.commit()
