...
def _scrape():
    #state the url
    url = "https://www.woolworths.co.za/prod/Food/Pantry/Global-Cuisine/Mexican/Sweet-Chilli-Flavoured-Tortilla-Corn-Chips-150-g/_/A-6009211601512?isFromPLP=true"
...
def update_db(_price):
    ...
    cur = conn.cursor()
    cur.execute("UPDATE groceries SET woolworths_price = (%s) WHERE id=5;", (_price,))
    conn.commit()
