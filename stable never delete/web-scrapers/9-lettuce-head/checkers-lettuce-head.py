...
def _scrape():
    #state the url
    url = "https://www.checkers.co.za/All-Departments/Food/Fresh-Food/Fresh-Salad%2C-Herbs-and-Dip/Lettuce-and-Salad-Bags/Crisp-Lettuce-Head-Pack/p/10684677EA"
...
def update_db(_price):
    ...
    cur = conn.cursor()
    cur.execute("UPDATE groceries SET checkers_price = (%s) WHERE id=9;", (_price,))
    conn.commit()
