...
def _scrape():
    ...
    url = "https://www.pnp.co.za/pnpstorefront/pnp/en/All-Products/Food-Cupboard/Canned-Foods-%26-Packets/Canned-Beans%2C-Vegetables-%26-Pasta/Canned-Beans%2C-Vegetables-%26-Pasta---Beans/Rhodes-Baked-Beans-In-Tomato-Sauce-410g/p/000000000000251667_EA"
...
def update_db(_price):
    ...
    cur = conn.cursor()
    cur.execute("UPDATE groceries SET pnp_price = (%s) WHERE id=7;", (_price,))
    conn.commit()   
