...
def _scrape():
    ...
    url = "https://www.pnp.co.za/pnpstorefront/pnp/en/All-Products/Fresh-Fruit-%26-Vegetables/Vegetables/Mushrooms/Denny-Brown-Mushrooms-250g/p/000000000000387742_EA"
...
def update_db(_price):
    ...
    cur = conn.cursor()
    cur.execute("UPDATE groceries SET pnp_price = (%s) WHERE id=11;", (_price,))
    conn.commit()   
