...
def _scrape():
    #state the url
    url = "https://www.checkers.co.za/All-Departments/Food/Fresh-Food/Fresh-Vegetables/Mushrooms/White-Button-Mushrooms-Pack-250g/p/10411767EA"
...
def update_db(_price):
    ...
    cur = conn.cursor()
    cur.execute("UPDATE groceries SET checkers_price = (%s) WHERE id=11;", (_price,))
    conn.commit()
