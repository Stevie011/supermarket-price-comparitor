...
def _scrape():
    ...
    url = "https://www.pnp.co.za/pnpstorefront/pnp/en/All-Products/Bakery/Rolls-%26-Bagels/PnP-Soft-Rolls-6s/p/000000000000239076_EA"
...
def update_db(_price):
    ...
    cur = conn.cursor()
    cur.execute("UPDATE groceries SET pnp_price = (%s) WHERE id=8;", (_price,))
    conn.commit()   
