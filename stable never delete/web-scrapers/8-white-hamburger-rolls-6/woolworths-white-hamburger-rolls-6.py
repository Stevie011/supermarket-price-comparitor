...
def _scrape():
    #state the url
    url = "https://www.woolworths.co.za/prod/Food/Bread-Bakery-Desserts/Bread-Rolls-Wraps-Bagels/Rolls/White-Rolls/White-Hamburger-Rolls-6-pk/_/A-20019068?isFromPLP=true"
...
def update_db(_price):
    ...
    cur = conn.cursor()
    cur.execute("UPDATE groceries SET woolworths_price = (%s) WHERE id=8;", (_price,))
    conn.commit()
