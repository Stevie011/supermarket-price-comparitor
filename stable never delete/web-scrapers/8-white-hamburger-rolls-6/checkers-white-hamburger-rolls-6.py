...
def _scrape():
    #state the url
    url = "https://www.checkers.co.za/All-Departments/Food/Bakery/Bread-and-Rolls/Bread-Rolls/White-Hamburger-Rolls-6-Pack/p/10151456PK1"
...
def update_db(_price):
    ...
    cur = conn.cursor()
    cur.execute("UPDATE groceries SET checkers_price = (%s) WHERE id=8;", (_price,))
    conn.commit()
