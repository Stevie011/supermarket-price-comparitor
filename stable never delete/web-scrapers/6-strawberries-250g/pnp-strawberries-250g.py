...
def _scrape():
    ...
    url = "https://www.pnp.co.za/pnpstorefront/pnp/en/All-Products/Fresh-Fruit-%26-Vegetables/Fruit/Strawberries/PnP-Strawberries-250g/p/000000000000545462_EA"
...
def update_db(_price):
    ...
    cur = conn.cursor()
    cur.execute("UPDATE groceries SET pnp_price = (%s) WHERE id=6;", (_price,))
    conn.commit()   
