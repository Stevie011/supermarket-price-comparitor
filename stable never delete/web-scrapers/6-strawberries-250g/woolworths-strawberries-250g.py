...
def _scrape():
    #state the url
    url = "https://www.woolworths.co.za/prod/Food/Promotions/Buy-2-Or-More-And-Save/Buy-any-2-save-R10/Strawberries/Strawberries-250-g/_/A-20017279?isFromPLP=true"
...
def update_db(_price):
    ...
    cur = conn.cursor()
    cur.execute("UPDATE groceries SET woolworths_price = (%s) WHERE id=6;", (_price,))
    conn.commit()
