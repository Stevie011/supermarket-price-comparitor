...
def _scrape():
    #state the url
    url = "https://www.woolworths.co.za/prod/Food/Milk-Dairy-Eggs/Milk/Fresh-Milk/Fresh-Full-Cream-Milk-2-L/_/A-20011697?isFromPLP=true"
...
def update_db(_price):
    ...
    cur = conn.cursor()
    cur.execute("UPDATE groceries SET woolworths_price = (%s) WHERE id=2;", (_price,))
    conn.commit()
