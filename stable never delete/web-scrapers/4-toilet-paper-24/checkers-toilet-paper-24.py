...
def _scrape():
    #state the url
    url = "https://www.checkers.co.za/All-Departments/Health-and-Beauty/Tissues-and-Toilet-Rolls/Multipack-Toilet-Roll/Baby-Soft-White-2-Ply-Toilet-Rolls-18-Pack/p/10135658EA"
...
def update_db(_price):
    ...
    cur = conn.cursor()
    cur.execute("UPDATE groceries SET checkers_price = (%s) WHERE id=4;", (_price,))
    conn.commit()
