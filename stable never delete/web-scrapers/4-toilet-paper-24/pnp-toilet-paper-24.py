...
def _scrape():
    #state the url
    url = "https://www.pnp.co.za/pnpstorefront/pnp/en/All-Products/Household-%26-Cleaning/Tissues-%26-Toilet-Paper/Toilet-Paper/Baby-Soft-2-Ply-Toilet-Paper-White-18s/p/000000000000215170_EA"
...
def update_db(_price):
    ...
    cur = conn.cursor()
    cur.execute("UPDATE groceries SET pnp_price = (%s) WHERE id=4;", (_price,))
    conn.commit()   
