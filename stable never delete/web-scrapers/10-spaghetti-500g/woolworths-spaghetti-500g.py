...
def _scrape():
    #state the url
    url = "https://www.woolworths.co.za/prod/Food/Pantry/Pasta-Rice-Grains/Pasta/Spaghetti-500-g/_/A-6009178658413?isFromPLP=true"
...
def update_db(_price):
    ...
    cur = conn.cursor()
    cur.execute("UPDATE groceries SET woolworths_price = (%s) WHERE id=10;", (_price,))
    conn.commit()
